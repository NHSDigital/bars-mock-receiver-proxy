...
def get_service_request(patientIdentifier: str, NHSD_Service: str = Header(...), NHSD_Token: str = Header(...)):
    return load_example("service_request/GET-success.json")


@route.post("/ServiceRequest", status_code=201)
def post_service_request(body: ServiceRequestBody, NHSD_Service: str = Header(...), NHSD_Token: str = Header(...)):
    return ""
